...
internal static class Mapping
{
    ...
    public static TableEntity ToEntity(EventRecord r)
    {
        ...
        var e = new TableEntity(EventsPartition, r.Slug)
        {
            ...
            ["CfpUrl"] = r.CfpUrl,
            ["CfpStatus"] = r.CfpStatus?.ToString(),
            ["EventUrl"] = r.EventUrl,
            ["Location"] = r.Location,
            ...
            ["FamilyConflictFlag"] = r.FamilyConflictFlag,
            ["PrepConflictFlag"] = r.PrepConflictFlag,
    ...
    public static EventRecord ToEventRecord(TableEntity e) => new()
    {
        ...
        CfpStatus = ParseEnum<CfpStatus>(e.GetString("CfpStatus")),
        ...
        FamilyConflictFlag = e.GetBoolean("FamilyConflictFlag") ?? false,
        PrepConflictFlag = e.GetBoolean("PrepConflictFlag") ?? false,
