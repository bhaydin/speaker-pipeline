...
/// accepted, or turned down drop out of the scoring candidate pool.
/// </summary>
public sealed class TrackerMaintenanceTimerTrigger(TrackerMaintenanceAgent agent, ILogger<TrackerMaintenanceTimerTrigger> logger)
{
